...
UNOWNED = [
    ...
    ("install-agents.sh",
     ...
     "file OWNS the gate tooling -- harness.md names this script as a "
     "step in make test and plan.md cites one of its refusals, so "
     "\"nothing describes it\" would be too strong."),
    ("proofs/mkcomp.py",
